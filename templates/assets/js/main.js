...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function E() {
        ...
        function h(t, e, n) {
            ...
            (((i = document.createElement("div")).className = "code-expand-btn"),
                (i.innerHTML = '<i class="fas fa-angle-double-down"></i>'),
        ...
        ((s = "prismjs" === a.plugin),
            (u = !(d = l = "") === n ? "closed" : ""),
        void 0 !== n &&
        (l = '<i class="fas fa-angle-down expand '.concat(u, '"></i>')),
        t &&
        (d =
                ...
                ? s
                    ...
                    : o.forEach(function (t) {
                        ...
                        ("plain" !== e && void 0 !== e) || (e = "Code"),
                            h('<div class="code-lang">'.concat(e, "</div>"), t, "hl");
                    })
                : s
                    ? o.forEach(function (t) {
    ...
    function l(t) {
        function e(t) {
            t.each(function (t, e) {
                ...
                -1 != o.indexOf("!blogimg")
                    ? n.wrap(
                        '<a href="'
                            .concat(o, '" data-fancybox="images" data-caption="')
                            .concat(a, '" class="fancybox" data-srcset="')
                            .concat(i, ' 1600w"></a>')
                    )
                    : n.wrap(
                        '<a href="'
        ...
        void 0 === $.fancybox
            ? ($("head").append(
                '<link rel="stylesheet" type="text/css" href="'.concat(
                    GLOBAL_CONFIG.source.fancybox.css,
                    '">'
                )
            ),
        ...
        btf.isJqueryLoad(function () {
            ...
            e.each(function (t, e) {
                ...
                d
                    ...
                    : ($("head").append(
                        '<link rel="stylesheet" type="text/css" href="'.concat(
                            GLOBAL_CONFIG.source.justifiedGallery.css,
                            '">'
                        )
                    ),
                        $.getScript(
