...
var heo_cookiesTime = null,
    ...
    heo = {
            ...
            fetch("https://moments.zhheo.com/randomfriend?num=3")
                ...
                .then(function (e) {
                    for (var t = getArrayItems(e, 3), o = "", n = 0; n < t.length; ++n) {
                        var a = t[n];
                        o += "<a class='footer-item' href='"
                            .concat(a.link, '\'  target="_blank" rel="noopener nofollow">')
                            .concat(a.name, "</a>");
                    }
                    (o += "<a class='footer-item' href='/link/'>更多</a>"),
        ...
        addTag: function () {
            ...
            $(".heo-tag-new").append(
                '<sup class="heo-tag heo-tag-new-view">N</sup>'
            ),
            document.querySelector(".heo-tag-hot") &&
            $(".heo-tag-hot").append(
                '<sup class="heo-tag heo-tag-hot-view">H</sup>'
            );
        },
